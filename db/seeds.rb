...
pattern_3 = Pattern.create(name: 'Toddlers Hooded Jumper', image_url: 'ToddlersHoodedJumper.png', download_url: '622713_Hooded-Jumper-Revised.pdf' , difficulty: 'beginner', size: 'One Size', likes: 0, user_id: 3)
...
pattern_19 = Pattern.create(name: 'Lily Sugar n Cream Go Green Market Bag', image_url: 'LilySugarnCreamGoGreenMarketBag.png', download_url: 'Patterns_628817_Lily-Go-Green-Market-Bag-Ptn-D.pdf', difficulty: 'beginner', size: '12in x 5in', likes: 0, user_id: 3)
pattern_20 = Pattern.create(name: 'Caron Cable Twist Hat', image_url: 'CaronCableTwistHat.png', download_url: 'CableTwistHat.pdf', difficulty: 'intermediate', size: 'One Size', likes: 0, user_id: 4)
